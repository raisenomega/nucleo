...
const nitroConfig = {
  ...
  handlers: [
    ...
    // v2a.5: render server-side del PDF del contrato firmado. Verificado en prod que Vercel ejecuta los
    // handlers Nitro en Node v24 (no Edge), que es lo que permite renderToBuffer sin navegador.
    { route: "/api/contract-pdf", handler: r("apps/web/server/contract-pdf-handler.ts") },
  ],
};

-- Permisos granulares (cost/salary/documents/categories/bank/fiscal). ceo/superadmin ya devuelven true
-- para toda perm; oper/servicio caen a false (no listan las keys nuevas). Solo coo necesita categories.

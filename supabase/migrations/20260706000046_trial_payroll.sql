-- 20260706000046_trial_payroll.sql
-- create_trial_tenant v5: los trials nuevos reciben el preset de nómina PR (seed_pr_payroll_preset, 00045).
-- Reemplaza la v4 (00035) añadiendo la llamada al preset de nómina tras el fiscal.

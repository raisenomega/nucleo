-- 20260705000026_trial_lead_categories.sql
-- Leads v2: los trials nuevos reciben categories demo de lead_source (6) + service_type (4).
-- Reemplaza create_trial_tenant (00014) añadiendo esas categorías al bloque de seed.

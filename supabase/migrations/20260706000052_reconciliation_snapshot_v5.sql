-- 20260706000052_reconciliation_snapshot_v5.sql
-- Break-even = presupuestado de recurring_expenses (lo que DEBES pagar) + nómina (decisión B).
-- health expone recurring_budgeted (prorrateado por frecuencia) + recurring_paid (gastos del mes en esas categorías).

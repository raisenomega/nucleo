...
import { custodyReceiptDoc } from "@assets/presentation/pdf/custody-doc";
...
export function AssetCustodyHistory({ assetId, assetName }: { assetId: string; assetName: string }) {
  const { t } = useI18n();

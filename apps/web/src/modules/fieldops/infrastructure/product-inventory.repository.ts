...
export async function getProductInventorySnapshot(productId: string): Promise<ProductSnapshot> {
  ...
  const item: InventoryItem = {
    ...
    categoryId: null, categoryName: null, unitOfMeasureId: null, unitOfMeasureAbbreviation: null, unitOfMeasureName: null, barcode: null, trackingType: "none", warehouseStock: [],
  };

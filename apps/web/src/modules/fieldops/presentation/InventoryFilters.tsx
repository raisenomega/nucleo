...
export type InvFilter = "all" | "low" | "catalog" | "nostock";
const CHIPS: [InvFilter, TranslationKey][] = [["all", "filterAll"], ["low", "filterLow"], ["catalog", "filterCatalog"], ["nostock", "filterNoStock"]];

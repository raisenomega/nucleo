...
export interface LandingConfig {
  ...
  schemaBusinessType: string; schemaGeoLat: number | null; schemaGeoLng: number | null; schemaPriceRange: string; sectionServicesTitle: string; sectionServicesSubtitle: string; sectionProductsTitle: string; sectionProductsSubtitle: string; sectionPackagesTitle: string; sectionPackagesSubtitle: string; catalogPageTitle: string; catalogPageSubtitle: string;
}

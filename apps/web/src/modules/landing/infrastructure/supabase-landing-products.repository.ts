...
const SEL = "id,category_id,slug,sku,name,short_description,long_description,price,compare_at_price,currency,tax_rate,stripe_price_id,track_inventory,stock_quantity,low_stock_threshold,primary_image_url,gallery_images,video_url,highlights,is_active,is_featured,display_order,attributes,meta_title,meta_description,is_published,form_id,cta_label,tenant_landing_categories(name)";

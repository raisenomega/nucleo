...
export interface ProductRow {
  ...
  primary_image_url: string | null; gallery_images: string[] | null; video_url: string | null; highlights: ItemHighlight[] | null;
  ...
  form_id?: string | null; cta_label?: string | null;
...
export const toLandingProduct = (r: ProductRow): ProductWithCategory => ({
  ...
  primaryImageUrl: r.primary_image_url, galleryImages: r.gallery_images ?? [], videoUrl: r.video_url, highlights: r.highlights ?? [],
  ...
  isPublished: r.is_published, formId: r.form_id ?? null, ctaLabel: r.cta_label ?? null, categoryName: catName(r.tenant_landing_categories),
});
...
export const toProductInput = (p: LandingProduct): ProductInput => ({
  ...
  videoUrl: p.videoUrl, highlights: p.highlights, isActive: p.isActive, isFeatured: p.isFeatured, displayOrder: p.displayOrder,
  attributes: p.attributes, metaTitle: p.metaTitle, metaDescription: p.metaDescription, isPublished: p.isPublished, formId: p.formId, ctaLabel: p.ctaLabel,
});
...
export const fromLandingProductInput = (i: ProductInput) => ({
  ...
  video_url: i.videoUrl, highlights: cleanHighlights(i.highlights), is_active: i.isActive, is_featured: i.isFeatured, display_order: i.displayOrder,
  attributes: i.attributes, meta_title: i.metaTitle || null, meta_description: i.metaDescription || null, is_published: i.isPublished, form_id: i.formId, cta_label: i.ctaLabel || null,
});

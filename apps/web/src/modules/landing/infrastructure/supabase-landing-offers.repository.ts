...
const SEL = "id,is_active,title_es,title_en,badge_text_es,badge_text_en,hook_price,applicable_services,commitment_cycles,disclosure_es,disclosure_en,cta_label_es,cta_label_en,terms_es,terms_en,ask_service_type,modal_question_es,modal_question_en,valid_from,valid_until,display_order";
...
const toOffer = (r: Row): Offer => ({
  ...
  termsEs: (r.terms_es as string) ?? "", termsEn: (r.terms_en as string) ?? "",
...
const fromOffer = (c: OfferInput) => ({
  ...
  terms_es: c.termsEs, terms_en: c.termsEn, ask_service_type: c.askServiceType, modal_question_es: c.modalQuestionEs, modal_question_en: c.modalQuestionEn,

...
const SEL = "id,category_id,slug,name,short_description,long_description,pricing_type,price,price_unit,duration_estimate_minutes,requires_scheduling,primary_image_url,gallery_images,highlights,landing_hero,is_active,is_featured,display_order,meta_title,meta_description,is_published,cta_label,tenant_landing_categories(name)";

...
const SEL = "id,slug,name,short_description,long_description,price,compare_at_price,currency,included_products,included_services,features_list,primary_image_url,gallery_images,highlights,is_active,is_featured,display_order,badge_label,meta_title,meta_description,is_published,cta_label";

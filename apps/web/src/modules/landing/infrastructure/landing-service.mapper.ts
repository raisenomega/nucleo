...
// Fila cruda de tenant_landing_services. gallery_images existe pero se ignora en 3.b.2 (reservado, D3).
export interface ServiceRow {
  ...
  primary_image_url: string | null; is_active: boolean; is_featured: boolean; display_order: number;
...
export const toLandingService = (r: ServiceRow): ServiceWithCategory => ({
  ...
  primaryImageUrl: r.primary_image_url, isActive: r.is_active, isFeatured: r.is_featured, displayOrder: r.display_order,
...
export const toServiceInput = (s: LandingService): ServiceInput => ({
  ...
  primaryImageUrl: s.primaryImageUrl, isActive: s.isActive, isFeatured: s.isFeatured, displayOrder: s.displayOrder,
...
export const fromLandingServiceInput = (i: ServiceInput) => ({
  ...
  primary_image_url: i.primaryImageUrl, is_active: i.isActive, is_featured: i.isFeatured, display_order: i.displayOrder,

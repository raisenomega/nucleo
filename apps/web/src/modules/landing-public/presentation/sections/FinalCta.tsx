...
// CTA final full-width con gradiente del tenant. id="contact" = ancla de las cards y del CTA del hero.
export function FinalCta({ title, subtitle, ctaLabel, ctaHref }: { title: string; subtitle: string; ctaLabel: string; ctaHref: string }) {
  return (
    <section id="contact" className="px-6 py-20 text-center text-white"

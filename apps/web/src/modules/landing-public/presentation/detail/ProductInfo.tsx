...
// Columna derecha del detail: descripción corta, precio, CTA cotizar, descripción larga (markdown → HTML).
export function ProductInfo({ product: p, onQuote }: { product: ProductFull; onQuote: () => void }) {
  const { t } = useI18n();
  return (
    <div>
      ...
      <FloatingButton onClick={onQuote} variant="primary" size="lg" className="mt-6">{t("lpDetailCtaQuote")}</FloatingButton>

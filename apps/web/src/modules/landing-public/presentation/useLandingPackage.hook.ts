...
const cache = createTtlCache<PackageData>(TTL_SHORT_60S);

// Fetch _public_get_landing_package(host, slug) — includeds expandidos server-side. Cache TTL 60s. FetchState.

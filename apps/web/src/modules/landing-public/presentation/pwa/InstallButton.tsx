...
// Botón "Instalar app": SIEMPRE visible (salvo si ya está instalada/standalone) para que el cliente siempre
// vea cómo instalar. Click → descarga NATIVA directa si el navegador la ofrece; si no (iOS/dismiss) → modal con pasos.

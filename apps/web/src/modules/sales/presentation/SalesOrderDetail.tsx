import { X, Check, Ban, FileOutput } from "lucide-react";
...
export function SalesOrderDetail({ order, canManage, onConfirm, onInvoice, onCancel, onClose }: {
  order: SalesOrder; canManage: boolean; onConfirm: () => void; onInvoice: () => void; onCancel: () => void; onClose: () => void;
}) {

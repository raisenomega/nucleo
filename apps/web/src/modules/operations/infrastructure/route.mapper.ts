...
export const toStop = (s: SRow): RouteStop => ({
  ...
  phone: s.phone, estimatedAmount: Number(s.estimated_amount), actualAmount: num(s.actual_amount),
...
export const stopRow = (routeId: string, order: number, s: StopFormData) => ({
  ...
  phone: s.phone || null, estimated_amount: s.estimatedAmount, notes: s.notes || null,
});

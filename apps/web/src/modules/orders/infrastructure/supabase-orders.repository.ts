...
const SEL = "id,order_number,customer_name,customer_email,customer_phone,items,subtotal,tax,shipping,discount,total,currency,status,source_hostname,utm_source,utm_medium,utm_campaign,linked_lead_id,linked_invoice_id,created_at,paid_at,payment_method_key,client_confirmed_at";

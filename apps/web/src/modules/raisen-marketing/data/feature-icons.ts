import { FileText, Route, BarChart3, Bot, Zap, Shield, Globe, Users, Code, Palette, TrendingUp, Heart, Star, Sparkles, Rocket, MessageSquare, Bell, Calendar, CreditCard, Package, Truck, Wrench, LayoutDashboard, UserPlus, type LucideIcon } from "lucide-react";

// Set de íconos lucide para features (landing + icon picker del editor). name → componente.

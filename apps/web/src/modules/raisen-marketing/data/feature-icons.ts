import { FileText, Route, BarChart3, Bot, Zap, Shield, Globe, Users, Code, Palette, TrendingUp, Heart, Star, Sparkles, Rocket, MessageSquare, Bell, Calendar, CreditCard, Package, Truck, Wrench, LayoutDashboard, UserPlus, Calculator, LayoutGrid, Building2, Handshake, Camera, ThumbsUp, Briefcase, Play, Music, AtSign, type LucideIcon } from "lucide-react";
...
export const FEATURE_ICONS: Record<string, LucideIcon> = {
  ...
  Camera, ThumbsUp, Briefcase, Play, Music, AtSign, // redes sociales del footer
};

...
export function MarketingTestimonials({ lang }: { lang: Lang }) {
  ...
  return (
    <section id="social_proof" aria-labelledby="social_proof-title" ref={ref} className="relative px-6 py-16 md:py-20">
      <div className="relative z-10 mx-auto max-w-6xl">
        <div className={`mb-16 text-center transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
          ...
          <h2 id="social_proof-title" className="font-display text-3xl font-bold tracking-tight text-foreground md:text-4xl lg:text-5xl">{es ? cfg.titleEs : cfg.titleEn}</h2>
        </div>

...
export function MarketingSolutions({ lang, setAudience }: { lang: Lang; setAudience: (a: Audience) => void }) {
  ...
  return (
    <section id="solutions" aria-labelledby="solutions-title" ref={ref} className="relative overflow-hidden px-6 py-16 md:py-20">
      ...
      <div className={`relative z-10 mx-auto max-w-5xl transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}>
        <div className="mb-12 text-center">
          ...
          <h2 id="solutions-title" className="font-display text-3xl font-bold tracking-tight text-foreground md:text-4xl lg:text-5xl">{es ? cfg.titleEs : cfg.titleEn}</h2>
        </div>

...
import { uploadMarketingMedia } from "@raisen-marketing/infrastructure/upload-marketing-media";

// Uploader inmediato: sube al seleccionar → setea la URL (el Guardar del editor la persiste). Preview + eliminar.
export function MediaUploadField({ label, kind, url, accept, onChange }: { label: string; kind: "video" | "image"; url: string | null; accept: string; onChange: (url: string | null) => void }) {

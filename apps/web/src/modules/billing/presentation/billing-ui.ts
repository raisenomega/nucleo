...
export const INV_ST_KEY: Record<InvoiceStatus, TranslationKey> = {
  draft: "isDraft", sent: "isSent", partially_paid: "isPartial", paid: "isPaid", overdue: "isOverdue", cancelled: "isCancelled",
};
export const INV_ST_COLOR: Record<InvoiceStatus, string> = {
  draft: "bg-secondary", sent: "bg-blue-100 text-blue-800 dark:bg-blue-500/20 dark:text-blue-300",
  partially_paid: "bg-amber-100 text-amber-800 dark:bg-amber-500/20 dark:text-amber-300", paid: "bg-green-100 text-green-800 dark:bg-green-500/20 dark:text-green-300",

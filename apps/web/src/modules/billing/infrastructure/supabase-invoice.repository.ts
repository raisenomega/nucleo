...
interface Row {
  id: string; invoice_number: string | null; client_name: string; phone: string | null; email: string | null;
...
const SEL = "id,invoice_number,client_name,phone,email,items,subtotal,tax,total,status,due_date,paid_at,linked_lead_id,linked_order_id,created_at";
...
const toInv = (r: Row): Invoice => ({
  id: r.id, invoiceNumber: r.invoice_number, clientName: r.client_name, phone: r.phone, email: r.email,

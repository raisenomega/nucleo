...
const fromItem = (i: InvoiceItem) => ({ description: i.description, quantity: i.quantity, unit_price: i.unitPrice, tax_pct: i.taxPct, discount_pct: i.discountPct, line_total: i.lineTotal, product_id: i.productId ?? null, sku: i.sku ?? null });

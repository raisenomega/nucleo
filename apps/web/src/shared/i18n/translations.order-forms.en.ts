...
export const enOrderForms = {
  ...
  ofOptions: "Options", ofAddOption: "Add option", ofOptPrice: "Price", ofOptUnitPrice: "Price/unit",
  ofAddonUnitPrice: "Price per additional unit", ofAddonUnitPriceHelp: "Applied per extra unit the customer adds, regardless of frequency.", ofMin: "Min", ofMax: "Max", ofRows: "Rows", ofStep: "Step", ofPattern: "Pattern (regex)", ofDefaultChecked: "Checked by default",

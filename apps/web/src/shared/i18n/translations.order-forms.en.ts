...
export const enOrderForms = {
  ...
  ofOptions: "Options", ofAddOption: "Add option", ofOptPrice: "Price", ofOptUnitPrice: "Price/unit", ofMin: "Min", ofMax: "Max", ofRows: "Rows", ofStep: "Step", ofPattern: "Pattern (regex)", ofDefaultChecked: "Checked by default",

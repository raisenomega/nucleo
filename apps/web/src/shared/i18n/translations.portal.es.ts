...
export const esPortal = {
  ...
  pFullName: "Nombre completo", pPhone: "Teléfono", pPhoneLocked: "Para cambiar tu teléfono, contacta al negocio.", pAddress: "Dirección", pCity: "Ciudad", pState: "Estado", pZip: "Código postal",

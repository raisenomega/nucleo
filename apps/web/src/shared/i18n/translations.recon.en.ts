...
export const enRecon = {
  ...
  couponAppliesTo: "Applies to",
  couponGenerate: "Generate code",
  couponUses: "Uses",
  couponPercent: "Percentage (%)",
  couponFixed: "Fixed amount ($)",
  couponKind_all: "All",
  couponKind_product: "Products",
  couponKind_service: "Services",
  couponKind_package: "Packages",
  couponErrData: "Code and value (>0) required",
  couponActive: "Active",

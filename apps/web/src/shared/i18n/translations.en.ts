...
export const en = {
  ...
  notAuthorized: "You don't have permission to view this page.", fiscalSection: "Fiscal", saPlatform: "Platform", saSiteWeb: "Website", saConfig: "Settings", saTenants: "Tenants", saAnalytics: "Analytics", saSiteVisits: "Site visits (30d)", saAiVisibility: "AI visibility (30d)", saLeadsCommercial: "Commercial leads", webCampaigns: "Campaigns", webSections: "Sections", webHero: "Hero", webFeatures: "Features", webProcess: "Process", webPricing: "Pricing", webTestimonials: "Testimonials", webSolutions: "Solutions", webFaq: "FAQ", webFooter: "Footer", webLegal: "Legal", webReservations: "Reservations", webAvailability: "Availability", comingSoonCms: "Coming soon — available in upcoming sessions.", saPlatformSubtitle: "NÚCLEO platform administration", saTenantsActive: "Active tenants", saLandingActive: "Active", businessHealth: "Business health", portfolio: "Portfolio", previousMonth: "Previous month", quarter: "Quarter", variation: "Variation", currentMonth: "This month", totalReceivable: "Receivable", overdueInvoices: "Overdue invoices", activeClients: "Active clients", newClients: "New this month", routesToday: "Today's routes", vehiclesInService: "In service", maintenanceAlerts: "Maint. alerts", geofenceAlerts: "Geofence events", inventoryValue: "Inventory value", cogsMonth: "COGS this month", quickActions: "Quick actions", registerIncome: "Register income", viewAlerts: "View alerts", netProfit: "Net profit", netMargin: "Net margin", loadError: "Load error", dashboardGeneral: "General", commercial: "Commercial", healthStatus: "Health", needsAttention: "Needs attention", critical: "Critical", expensesByCategory: "Expenses by category", arAging: "AR aging", inventoryByWarehouse: "Value by warehouse", salesFunnel: "Sales funnel", leadsByTemperature: "Leads by temperature", quotesByStatus: "Quotes by status", topDebtors: "Top debtors", netBalance: "Net balance", overdueBills: "Overdue bills", recentPayments: "Recent payments", chartNeedHistory: "Not enough history yet to show the trend. You need at least 2 months of data.", chartNoAr: "No receivables pending. All your invoices are up to date.", chartNoAp: "No payables pending.",

...
export const esAssets = {
  ...
  generatePdf: "Generar PDF", routesDone: "Rutas realizadas", printReceipt: "Imprimir recibo", enterOdometer: "Ingresa el odómetro", selectEmployee: "Selecciona el empleado",

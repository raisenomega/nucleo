...
export const esQuotes = {
  ...
  quoteLinkExpired: "Este link ya no es válido. Es posible que el negocio te haya enviado una versión más reciente.",
  quoteLinkExpiredContact: "Contactá a {name} al {phone} para más información.",
  quoteAlreadyResponded: "Esta cotización ya fue respondida.",
  quoteAlreadyRespondedContact: "Contactá a {name} al {phone} si necesitás más información.",
  ...
  quoteReviewPdfFirst: "Revisá el PDF antes de decidir.", quoteAcceptQuestion: "¿Aceptás esta cotización?",

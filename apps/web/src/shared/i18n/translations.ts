...
export type TranslationKey =
  ...
  | "trialBanner" | "trialEnded" | "trialEndedDesc" | "scheduleConsultation" | "income"
  | "incomeList" | "newIncome" | "amount" | "category" | "description" | "date"
...
export const translations: Record<Locale, Record<TranslationKey, string>> = {
  es: {
    ...
    welcome: "Bienvenido a NÚCLEO",
    role: "Rol",
    logout: "Cerrar sesión",
    trialBanner: "Te quedan {days} días de prueba",
    trialEnded: "Tu prueba terminó",
    trialEndedDesc: "Agenda una consulta para seguir con NÚCLEO.",
  ...
  en: {
    ...
    welcome: "Welcome to NÚCLEO",
    role: "Role",
    logout: "Log out",
    trialBanner: "You have {days} days left in your trial",
    trialEnded: "Your trial has ended",
    trialEndedDesc: "Schedule a consultation to keep using NÚCLEO.",

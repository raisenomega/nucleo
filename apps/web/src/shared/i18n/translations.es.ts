...
export const es = {
  ...
  notAuthorized: "No tienes permiso para ver esta página.", fiscalSection: "Fiscal", saPlatform: "Plataforma", saSiteWeb: "Sitio web", saConfig: "Configuración", saTenants: "Tenants", saLeadsCommercial: "Leads comercial", webSections: "Secciones", webHero: "Hero", webFeatures: "Features", webProcess: "Proceso", webPricing: "Precios", webTestimonials: "Testimonios", webFooter: "Footer", comingSoonCms: "Próximamente — disponible en las próximas sesiones.", saPlatformSubtitle: "Administración de la plataforma NÚCLEO", saTenantsActive: "Tenants activos", saLandingActive: "Activa",

...
export const esOrderForms = {
  ...
  ofOptions: "Opciones", ofAddOption: "Agregar opción", ofOptPrice: "Precio", ofOptUnitPrice: "Precio/pieza",
  ofAddonUnitPrice: "Precio por unidad adicional", ofAddonUnitPriceHelp: "Se aplica por cada unidad extra que añada el cliente, independiente de la frecuencia.", ofMin: "Mínimo", ofMax: "Máximo", ofRows: "Filas", ofStep: "Paso", ofPattern: "Patrón (regex)", ofDefaultChecked: "Marcado por default",
  ...
  ofKindDate: "Fecha", ofKindAddress: "Dirección completa", ofKindMatrix: "Matriz de precios", ofKindAddons: "Complementos", ofKindRepeatable: "Grupo repetible", ofKindFile: "Subir archivo", ofKindDisclaimer: "Aviso / Disclaimer",

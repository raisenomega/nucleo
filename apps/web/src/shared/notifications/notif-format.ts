import { ShoppingCart, UserPlus, Calendar, FileText, Package, Truck, Bell,
  LifeBuoy, ClipboardCheck, Eye, Award, GraduationCap, Users } from "lucide-react";
...
const ICONS: Record<string, LucideIcon> = {
  ...
  ticket: LifeBuoy, evaluation: ClipboardCheck, observation: Eye, certification: Award, training: GraduationCap, employee: Users,
};
...
const ROUTES: Record<string, string> = {
  ...
  ticket: "/support", evaluation: "/evaluations", observation: "/observations", certification: "/settings-team", training: "/training", employee: "/settings-team",
};

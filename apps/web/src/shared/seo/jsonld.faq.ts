...
const FALLBACK: SeoFaq[] = [
  { qEs: "¿Qué es NÚCLEO?", qEn: "What is NÚCLEO?",
  ...
  { qEs: "¿Cuánto cuesta NÚCLEO?", qEn: "How much does NÚCLEO cost?",
  ...
  { qEs: "¿Puedo usar NÚCLEO con mi propia marca?", qEn: "Can I use NÚCLEO with my own brand?",

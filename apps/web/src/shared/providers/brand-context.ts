...
export interface Brand {
  ...
  landingEnabled: boolean; glEnabled: boolean; gpsRealtimeEnabled: boolean; reload: () => void;
}
export const EMPTY_BRAND: Brand = {
  tenantId: null, displayName: "", legalName: "", logoUrl: null, faviconUrl: null,
  theme: EMPTY_THEME, isLoading: true, landingEnabled: false, glEnabled: false, gpsRealtimeEnabled: false, reload: () => {},
};

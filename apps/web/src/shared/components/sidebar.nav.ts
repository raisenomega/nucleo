...
export const FULFILLMENT_NAV: NavItem[] = [{ key: "salesOrders", icon: ShoppingCart, to: "/sales-orders", mod: "sales" }, { key: "deliveryNotes", icon: Truck, to: "/delivery-notes", mod: "sales" }]; // salesCrm si fulfillment

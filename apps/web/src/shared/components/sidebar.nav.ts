...
export const FULFILLMENT_NAV: NavItem[] = [{ key: "salesOrders", icon: ShoppingCart, to: "/sales-orders", mod: "sales" }]; // salesCrm si fulfillment
...
export const HR_SECTION: NavSection = { title: "hr", icon: Users, items: [
  { key: "recruitment", icon: UserPlus, to: "/recruitment", mod: "settings" }, { key: "onboarding", icon: ClipboardList, to: "/onboarding" }, { key: "team", icon: Users, to: "/settings-team", mod: "settings" }, { key: "attendance", icon: Clock, to: "/attendance" }, { key: "leave", icon: CalendarOff, to: "/leave" }, { key: "payroll", icon: Banknote, to: "/payroll", mod: "payroll" }, { key: "evaluations", icon: ClipboardCheck, to: "/evaluations", mod: "evaluations" },

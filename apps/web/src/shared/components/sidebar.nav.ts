import {
  ...
  BookOpen, BookMarked, ScrollText, TrendingUp, Lock,
} from "lucide-react";
...
export const ACCOUNTING_SECTION: NavSection = { title: "accounting", icon: BookOpen, items: [
  { key: "chartOfAccounts", icon: BookMarked, to: "/accounting/chart", mod: "accounting" }, { key: "generalLedger", icon: ScrollText, to: "/accounting/journal", mod: "accounting" }, { key: "incomeStatement", icon: TrendingUp, to: "/accounting/income-statement", mod: "accounting" }, { key: "balanceSheet", icon: Scale, to: "/accounting/balance-sheet", mod: "accounting" }, { key: "periodClose", icon: Lock, to: "/accounting/period-close", mod: "accounting" }] };

import { HelpCircle, LayoutDashboard, Building2, Inbox, LayoutList, Target, Zap, ArrowRight, DollarSign, MessageSquare, Lightbulb, FileText, Scale, CalendarCheck, CalendarClock, BarChart3, Megaphone, ShieldCheck } from "lucide-react";
...
export const SUPERADMIN_SECTIONS: NavSection[] = [
  ...
  { title: "saSecurity", icon: ShieldCheck, items: [{ key: "saSecurity", icon: ShieldCheck, to: "/security" }] },

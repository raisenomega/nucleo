...
import { useInstallPrompt } from "@shared/portal/useInstallPrompt.hook";
...
function PortalSettings() {
  ...
  return (
    <div className="space-y-4">
      ...
      {canInstall && sec(t("pInstall"), <button type="button" onClick={install} className="rounded-lg bg-primary text-primary-foreground px-4 py-2 text-sm font-bold">{t("pInstallApp")}</button>)}
